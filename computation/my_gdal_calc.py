...
def Calc(
        ...
        # Passes a creation option to the output format driver. Multiple options may be listed
        creation_options: Optional[Sequence[str]] = None,
        # process all bands of given raster [a-z, A-Z]
        allBands: str = '',
        # overwrite output file if it already exists
        overwrite: bool = False,
        # ignores the NoDataValues of the input rasters
        hideNoData: bool = False,
        # check that all rasters share the same projection
        projectionCheck: bool = False,
        # color table file name
        color_table: Optional[ColorTableLike] = None,
        # how to treat mixed geotransforms
