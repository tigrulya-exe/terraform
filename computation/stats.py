...
def draw_polar_diagrams(
    ...
    slope_bytes = get_flat_band(open_tiff(slope_path), 1)
    aspect_bytes = get_flat_band(open_tiff(aspect_path), 1)

    img_ds = open_tiff(img_path)
...
draw_polar_diagrams(
    ...
    slope_path="..\\test_files\SLOPE_3.tif",
    aspect_path="..\\test_files\ASPECT_3.tif",
